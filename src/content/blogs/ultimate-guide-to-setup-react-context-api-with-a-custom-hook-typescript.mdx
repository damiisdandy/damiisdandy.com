...
summary: This is a guide to help you set up React Context API with typescript.
image: /og/g8q4en8rdif020w5fx2p.jpg
tags: React, Typescript, Context API, Custom Hook, Tutorial
type: post
---
...
That's all for this tutorial 🎉, This is my first article 😅.

<RepositoryCard name="context-api-typescript" />
