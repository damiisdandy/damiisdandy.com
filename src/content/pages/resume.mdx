...
and tutorials.
<Tools
  tools={["React", "Vuejs", "SCSS", "Nodejs", "Technical Writing", "PWA"]}
/>
<Divider />
...
<br />
[Jetron Ticket](https://jetronticket.com/) is platform to discover events and handle
the ticketing system for events in West Africa, I built this platform not only because
I noticed a gap in the event space within Nigeria but also to learn how to build
